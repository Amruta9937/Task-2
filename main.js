...
bhconsole.log('INFINITY TEAM API ');
function getData(a)
{
    ...
    fetch(url).then((response)=>{
       ...
       var value=data;       
           ...
           document.getElementById('r2img').src = img2;
           var img3=(value['data'][2]['avatar']);
           document.getElementById('r3img').src = img3;
           var img3=(value['data'][3]['avatar']);
           document.getElementById('r4img').src = img3;
           var img3=(value['data'][4]['avatar']);
           document.getElementById('r5img').src = img3;
           var img3=(value['data'][5]['avatar']);
           document.getElementById('r6img').src = img3;
           ///// name
